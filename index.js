...

{
  ...
  function buildFooter(footerData) {
    ...
    contactEmailP.textContent = `Email: <a href="mailto:${footerData.containEmail}"> ${footerData.contractEmail}</a>`
